...
const REF_LOGO = "https://placehold.co/120x32/4B4AD5/fff?text=TP";
const REF_AVATAR = "https://placehold.co/36x36/E2E2EA/717179?text=DR";

// Inline SVG replacements for iconsax-reactjs icons
function HospitalIcon({ size = 20, color = "currentColor", strokeWidth = 1.5, ...rest }) {
  return (
    <svg
      ...
      <path d="M2 10h20" />
      <path d="M12 10v10" />
      <path d="M8 10V6a4 4 0 0 1 4-4 4 4 0 0 1 4 4v4" />
    </svg>
  );
}

function BellIcon({ size = 20, color = "currentColor", strokeWidth = 1.5, ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
function CheckCircleIcon({ size = 14, color = "currentColor", ...rest }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
    ...
    <header className="flex h-[62px] shrink-0 items-center border-b border-tp-slate-100 bg-tp-slate-0 px-4 py-2.5">
      ...
      <div className="flex items-center gap-3.5">
        ...
        <button
          ...
          <BellIcon size={20} color="var(--tp-slate-700)" strokeWidth={1.5} />
        ...
        <div className="relative hidden sm:block" ref={clinicMenuRef}>
          <button
            ...
            <HospitalIcon size={20} strokeWidth={1.5} color="var(--tp-slate-700)" />
                  ...
                  {filteredClinics.length === 0 ? (
                    ...
                    filteredClinics.map((clinic) => (
                      <button
                        ...
                        {clinic.id === activeClinic && (
                          <CheckCircleIcon size={14} color="var(--tp-blue-500)" />
                        )}
                      </button>
                    ))
                  )}
