...
export const typographyTokens = {
  ...
  { token: "TP.text.h2", value: "30px/38px", cssVar: "--tp-text-h2", property: "font", description: "Section titles, card headers. Inter 600" },
  { token: "TP.text.h3", value: "24px/32px", cssVar: "--tp-text-h3", property: "font", description: "Sub-section headers. Inter 600" },
  { token: "TP.text.h4", value: "20px/28px", cssVar: "--tp-text-h4", property: "font", description: "Card titles, widget headers. Inter 600" },
  { token: "TP.text.h5", value: "16px/24px", cssVar: "--tp-text-h5", property: "font", description: "Small section titles. Inter 600" },
  { token: "TP.text.h6", value: "14px/20px", cssVar: "--tp-text-h6", property: "font", description: "Overlines, uppercase labels. Inter 600" },
  ...
  { token: "TP.text.overline", value: "12px/14px", cssVar: "--tp-text-overline", property: "font", description: "Section overlines. Inter 700, tracking 0.08em" },
...
export const allComponentTokenGroups = [
typographyTokens,
spacingTokens,
shadowTokens,
radiusTokens,
