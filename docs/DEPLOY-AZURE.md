...
on port **8080**. The deployed site keeps the password login gate (see
...
- **CI option:** you can wire `az acr build` into a GitHub Action on push/release if
  you want auto-deploys (ask and I'll add the workflow).
